...
## 6. Next Steps for Authors

1. Export database tables to CSV in the formats above (or provide SQL dump + export script).
2. Provide annotation protocols and any inter-rater reliability data.
...
5. Update this document when data is released or shared under restricted access.
